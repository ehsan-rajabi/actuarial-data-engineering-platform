...
assumption_files = [
    "assumptions/assumptions_expected.txt",
    "assumptions/assumptions_wage_real.txt",
    "assumptions/assumptions_annuity_real.txt",
    "assumptions/assumptions_discount_real.txt",
    "assumptions/assumptions_actual.txt"
]
...
balance_sheet_df=pd.DataFrame(balance_sheet_results)
balance_sheet_df = balance_sheet_df.set_index("scenario").transpose()
balance_sheet_df.loc["total_accured_liabilities"]=(balance_sheet_df.loc["normal_cost"]+
                                                   balance_sheet_df.loc["accrued_liability"]+
                                                   balance_sheet_df.loc["death_liability"]+
                                                   balance_sheet_df.loc["retired_liability"]+
                                                   balance_sheet_df.loc["survivor_liability"])

balance_sheet_df.loc["total_perimiums"]=(balance_sheet_df.loc["future_premiums_employee"]+balance_sheet_df.loc["future_premiums_employer"])
balance_sheet_df.loc["unfunded_actuarial_liability_expected"]=(balance_sheet_df.loc["total_accured_liabilities"]-balance_sheet_df.loc["total_perimiums"]-balance_sheet_df.loc["assets"])

final_balance_sheet=pd.DataFrame(index=[
                                        "normal_cost",
                                        "accrued_liability_employee",
                                        "death_liability",
                                        "retired_liability",
                                        "survivor_liability",
                                        "total_accured_liabilities",
                                        "future_premiums_employer",
                                        "future_premiums_employee",
                                        "total_premiums",
                                        "assets",
                                        "unfunded_actuarial_liability_expected",
                                        "unfunded_acturial_liability_real_wage",
                                        "unfunded_actuarial_liability_real_anniuity",
                                        "unfunded_actuarial_liability_real_discount_rate",
                                        "unfunded_actuarial_liability_actual",
                                        "actuarial_gain",
                                        "actuarial_cost"
                                       ],columns=["amount"])

print(balance_sheet_df.head(30))
final_balance_sheet.loc["normal_cost","amount"]=balance_sheet_df.loc["normal_cost","assumptions_expected.txt"]
final_balance_sheet.loc["accrued_liability_employee","amount"]=balance_sheet_df.loc["accrued_liability","assumptions_expected.txt"]
final_balance_sheet.loc["death_liability","amount"]=balance_sheet_df.loc["death_liability","assumptions_expected.txt"]
final_balance_sheet.loc["retired_liability","amount"]=balance_sheet_df.loc["retired_liability","assumptions_expected.txt"]
final_balance_sheet.loc["survivor_liability","amount"]=balance_sheet_df.loc["survivor_liability","assumptions_expected.txt"]
final_balance_sheet.loc["total_accured_liabilities","amount"]=balance_sheet_df.loc["total_accured_liabilities","assumptions_expected.txt"]
final_balance_sheet.loc["future_premiums_employer","amount"]=balance_sheet_df.loc["future_premiums_employer","assumptions_expected.txt"]
final_balance_sheet.loc["future_premiums_employee","amount"]=balance_sheet_df.loc["future_premiums_employee","assumptions_expected.txt"]
final_balance_sheet.loc["total_premiums","amount"]=balance_sheet_df.loc["total_perimiums","assumptions_expected.txt"]
final_balance_sheet.loc["assets","amount"]=balance_sheet_df.loc["assets","assumptions_expected.txt"]
final_balance_sheet.loc["unfunded_actuarial_liability_expected","amount"]=balance_sheet_df.loc["unfunded_actuarial_liability_expected","assumptions_expected.txt"]
final_balance_sheet.loc["unfunded_acturial_liability_real_wage","amount"]=balance_sheet_df.loc["unfunded_actuarial_liability_expected","assumptions_wage_real.txt"]
final_balance_sheet.loc["unfunded_actuarial_liability_real_anniuity","amount"]=balance_sheet_df.loc["unfunded_actuarial_liability_expected","assumptions_annuity_real.txt"]
final_balance_sheet.loc["unfunded_actuarial_liability_real_discount_rate","amount"]=balance_sheet_df.loc["unfunded_actuarial_liability_expected","assumptions_discount_real.txt"]
final_balance_sheet.loc["unfunded_actuarial_liability_actual","amount"]=balance_sheet_df.loc["unfunded_actuarial_liability_expected","assumptions_actual.txt"]
final_balance_sheet.loc["actuarial_gain","amount"]=balance_sheet_df.loc["unfunded_actuarial_liability_expected","assumptions_expected.txt"]- balance_sheet_df.loc["unfunded_actuarial_liability_expected","assumptions_actual.txt"]
final_balance_sheet.loc["actuarial_cost","amount"]=final_balance_sheet.loc["unfunded_actuarial_liability_actual","amount"]/4.95
final_balance_sheet["amount"]=(final_balance_sheet["amount"]/1_000_000).round().astype(int)
print(final_balance_sheet.to_string(formatters={"amount":"{:,}".format}))
